...
/**
 * @brief Initialize the shared SPI2_HOST bus and configure GPIOs for shift registers.
 * Enforces boot safety constraints to prevent relay misfire.
 * 
 ...
 * 
 * @param button_states Pointer to store the 32-bit absolute state of all inputs.
 * @return esp_err_t ESP_OK on success.
 */
